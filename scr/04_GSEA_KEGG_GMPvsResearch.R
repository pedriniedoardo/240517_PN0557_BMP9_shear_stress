...
df_tables_GSEA_all %>%
  write_tsv("../../out/table/df_tables_GSEA_res_GMPvsRESEARCH_shr_all_KEGG.tsv")
...
# save the table
df_tables_GSEA_all_non_redundant %>%
  write_tsv(file = "../../out/table/df_table_GSEA_res_GMPvsRESEARCH_shr_nonredundant_KEGG.tsv")
...
ggsave("../../out/image/GSEA_unbiased_res_GMPvsRESEARCH_shr_nonredundant_KEGG.pdf",width = 15,height = 10)
...
df_tables_GSEA_all %>%
  ...
  theme(strip.background = element_blank())+
  geom_text_repel(size = 2,box.padding = 0.5,segment.alpha = 0.6,max.overlaps = 10)
ggsave("../../out/image/GSEA_unbiased_res_GMPvsRESEARCH_shr_KEGG.pdf",width = 15,height = 9)
