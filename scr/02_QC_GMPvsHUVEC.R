...
# read in the data --------------------------------------------------------
ddsHTSeq <- readRDS("../../out/object/dds_all_raw_GMPvsHUVEC.rds")
...
ggsave("../../out/image/barplot_tot_count_all_GMPvsHUVEC.pdf",width = 7,height = 5)
...
saveRDS(ddsHTSeq_filter,file = "../../out/object/dds_all_filter_GMPvsHUVEC.rds")
...
ggsave(plot = meanSdPlot_vsd$gg+theme_bw(),filename = "../../out/image/meanSdPlot_vsd_GMP_vs_HUVEC_ECFCs.pdf",width = 4,height = 4)

meanSdPlot_rlog <- meanSdPlot(assay(rld_filter))
ggsave(plot = meanSdPlot_rlog$gg+theme_bw(),filename = "../../out/image/meanSdPlot_rlog_GMP_vs_HUVEC_ECFCs.pdf",width = 4,height = 4)
...
pdf("../../out/image/heatmap_vsd_GMP_vs_HUVEC_ECFCs.pdf",width = 7,height = 5)
hm_1
dev.off()
...
pdf("../../out/image/heatmap_rld_GMP_vs_HUVEC_ECFCs.pdf",width = 7,height = 5)
hm_1_2
dev.off()
...
pdf("../../out/image/heatmap_poisd_GMP_vs_HUVEC_ECFCs.pdf",width = 7,height = 5)
hm_p
dev.off()

# plot cluster alternative ------------------------------------------------
# set seed to control random annotation colors
pdf("../../out/image/heatmap_cluster_all_GMP_vs_HUVEC_ECFCs.pdf",width = 7,height = 5)
set.seed(1)
...
ggsave("../../out/image/PCA_vsd_GMP_vs_HUVEC_ECFCs.pdf",width = 5,height = 4)
...
ggsave("../../out/image/panel_metadata_PC_GMP_vs_HUVEC_ECFCs.pdf",width = 20,height = 10)
...
ggsave("../../out/image/PCA_rld_GMP_vs_HUVEC_ECFCs.pdf",width = 5,height = 4)
...
ggsave("../../out/image/MDS_vsd_GMP_vs_HUVEC_ECFCs.pdf",width = 5,height = 4)
...
ggplot(mds_rld, aes(x = `1`, y = `2`, color = Condition)) +
  geom_point(size = 3) + theme_bw()
ggsave("../../out/image/MDS_rld_GMP_vs_HUVEC_ECFCs.pdf",width = 5,height = 4)
...
ggplot(mdsPois, aes(x = `1`, y = `2`, color = Condition)) +
  geom_point(size = 3) + theme_bw()
ggsave("../../out/image/PoissonDistance_scatter_GMP_vs_HUVEC_ECFCs.pdf",width = 5,height = 4)

# save the object of interest ---------------------------------------------
saveRDS(vds_filter,file = "../../out/object/vds_all_filter_GMP_vs_HUVEC_ECFCs.rds")
saveRDS(vsd_blind,file = "../../out/object/vsd_all_blind_GMP_vs_HUVEC_ECFCs.rds")
saveRDS(rld_filter,file = "../../out/object/rld_all_filter_GMP_vs_HUVEC_ECFCs.rds")
saveRDS(rld_blind,file = "../../out/object/rld_all_blind_GMP_vs_HUVEC_ECFCs.rds")
