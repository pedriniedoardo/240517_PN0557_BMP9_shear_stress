...
# gobp_gene_sets <- msigdbr(species = "Homo sapiens", category = "C2",subcategory = "CP:KEGG")
...
df_tables_GSEA_all %>%
  write_tsv("../../out/table/df_tables_GSEA_res_GMPvsRESEARCH_shr_all_GOBP.tsv")
...
# save the table
df_tables_GSEA_all_non_redundant %>%
  write_tsv(file = "../../out/table/df_table_GSEA_res_GMPvsRESEARCH_shr_nonredundant_GOBP.tsv")
...
ggsave("../../out/image/GSEA_unbiased_res_GMPvsRESEARCH_shr_nonredundant_GOBP.pdf",width = 15,height = 10)
...
df_tables_GSEA_all %>%
  ...
  theme(strip.background = element_blank())+
  geom_text_repel(size = 2,box.padding = 0.5,segment.alpha = 0.6,max.overlaps = 10)
ggsave("../../out/image/GSEA_unbiased_res_GMPvsRESEARCH_shr_GOBP.pdf",width = 15,height = 9)
...
ggsave(filename = "../../out/image/GSEA_plot_profile_GMPvsRESEARCH_shr_nonredundant_GOBP.pdf",width = 15,height = 10)
