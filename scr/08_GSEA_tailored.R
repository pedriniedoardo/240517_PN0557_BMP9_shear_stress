...
df_tables_GSEA_all_non_redundant <- read_tsv(file = "../../out/table/df_tables_GSEA_res_GMPvsRESEARCH_shr_all_KEGG.tsv")
...
df_test |> 
  filter(str_detect(pathway,pattern = c("KEGG_PRIMARY_IMMUNODEFICIENCY|KEGG_GLYCOLYSIS_GLUCONEOGENESIS|KEGG_VEGF_SIGNALING_PATHWAY|KEGG_CELL_CYCLE|KEGG_CELL_ADHESION_MOLECULES_CAMS|KEGG_ECM_RECEPTOR_INTERACTION")
  ))
...
ggsave("../../out/image/volcano_GSEA_KEGG_GMPvsRESEARCH_tailored.pdf",width = 8,height = 5)
...
pdf("../../out/image/heatmap_DEG_KEGG_GMPvsRESEARCH_leadingEdges.pdf",width = 7,height = 8)
